...
pub fn action_label(action: AppAction) -> &'static str {
    match action {
        ...
        AppAction::CancelCurrentMode => "Cancel",
        ...
        AppAction::DecreaseTempo => "Tempo Down",
        AppAction::IncreaseTempo => "Tempo Up",
        AppAction::HalfTempo => "Half Tempo",
        AppAction::DoubleTempo => "Double Tempo",
        ...
        AppAction::ToggleAutoThru => "Auto THRU",
        ...
        AppAction::OpenTimelineFxMenu => "Open Timeline FX Options",
        AppAction::SelectTimelineFxSlot(0) => "Select Timeline FX Slot 1",
        AppAction::SelectTimelineFxSlot(1) => "Select Timeline FX Slot 2",
        AppAction::SelectTimelineFxSlot(2) => "Select Timeline FX Slot 3",
        AppAction::SelectTimelineFxSlot(3) => "Select Timeline FX Slot 4",
        AppAction::SelectTimelineFxSlot(_) => "Select Timeline FX Slot",
        ...
        AppAction::AdjustSelectedTimelineFxThird => "Adjust Timeline FX Param 3",
        AppAction::AdjustSelectedTimelineFxFourth => "Adjust Timeline FX Param 4",
...
pub fn built_in_keyboard_binding_labels(action: AppAction) -> &'static [&'static str] {
    match action {
        ...
        AppAction::CancelCurrentMode => &["Escape"],
        ...
        AppAction::OpenTimelineFxMenu => &["Shift+Enter", "Shift+F10"],
        AppAction::SelectTimelineFxSlot(0) => &["Shift+1"],
        AppAction::SelectTimelineFxSlot(1) => &["Shift+2"],
        AppAction::SelectTimelineFxSlot(2) => &["Shift+3"],
        AppAction::SelectTimelineFxSlot(3) => &["Shift+4"],
        ...
        AppAction::AdjustSelectedTimelineFxThird | AppAction::AdjustSelectedTimelineFxFourth => {
            &["Q/E"]
        }
        AppAction::ScrollSelectedTimelineFxWindow => &["Q/E"],
        AppAction::MoveSelectedTimelineFxUp => &["Ctrl+Up"],
        AppAction::MoveSelectedTimelineFxDown => &["Ctrl+Down"],
