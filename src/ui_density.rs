...
pub struct UiMetrics {
    ...
    pub track_indicator_inset_x_px: i32,
    pub track_indicator_inset_y_px: i32,
    pub track_indicator_gap_px: i32,
    pub mapping_badge_height_px: u32,
    pub mapping_header_y_px: i32,
    pub mapping_list_y_px: i32,
    pub mapping_list_bottom_inset_px: i32,
    pub mapping_footer_height_px: u32,
    pub mapping_footer_bottom_inset_px: i32,
    ...
    pub midi_list_top_gap_px: i32,
    pub midi_list_bottom_gap_px: i32,
...
const DEFAULT_METRICS: UiMetrics = UiMetrics {
    ...
    track_indicator_inset_x_px: 2,
    track_indicator_inset_y_px: 2,
    track_indicator_gap_px: 2,
    mapping_badge_height_px: 16,
    mapping_header_y_px: 30,
    mapping_list_y_px: 44,
    mapping_list_bottom_inset_px: 24,
    mapping_footer_height_px: 12,
    mapping_footer_bottom_inset_px: 8,
    ...
    midi_list_top_gap_px: 6,
    midi_list_bottom_gap_px: 28,
...
const COMPACT_METRICS: UiMetrics = UiMetrics {
    ...
    track_indicator_inset_x_px: 2,
    track_indicator_inset_y_px: 1,
    track_indicator_gap_px: 1,
    mapping_badge_height_px: 14,
    mapping_header_y_px: 26,
    mapping_list_y_px: 38,
    mapping_list_bottom_inset_px: 20,
    mapping_footer_height_px: 10,
    mapping_footer_bottom_inset_px: 6,
    ...
    midi_list_top_gap_px: 4,
    midi_list_bottom_gap_px: 22,
...
const TOUCH_METRICS: UiMetrics = UiMetrics {
    ...
    mapping_list_bottom_inset_px: 30,
    mapping_footer_height_px: 14,
    mapping_footer_bottom_inset_px: 10,
    ...
    midi_list_top_gap_px: 8,
    midi_list_bottom_gap_px: 34,
