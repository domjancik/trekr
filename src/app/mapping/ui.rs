...
pub(crate) fn mapping_target_label_for_action(action: AppAction) -> Option<&'static str> {
    match action {
        ...
        AppAction::DecreaseTempo => Some("Tempo Down"),
        AppAction::IncreaseTempo => Some("Tempo Up"),
        AppAction::HalfTempo => Some("Half Tempo"),
        AppAction::DoubleTempo => Some("Double Tempo"),
        AppAction::TapTempo => Some("Tap Tempo"),
